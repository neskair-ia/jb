...
// +54 9 3816 45-2900 -> KzU0IDkgMzgxNiA0NS0yOTAw
// jb@jbingenieriacorporativa.com.ar -> amJAamJpbmdlbmllcmlhY29ycG9yYXRpdmEuY29tLmFy

export const CONTACT = {
  whatsapp: 'NTQ5MzgxNjQ1MjkwMD90ZXh0PVF1aWVybyUyMHNvbGljaXRhciUyMHVuYSUyMGNvdGl6YWNpJUMzJUIzbiUyMGRlLi4u', 
  whatsappRaw: '+54 9 3816 45-2900',
  phoneBase64: 'KzU0OTM4MTY0NTI5MDA=',
  callBase64: 'KzU0OTM4MTY0NTI5MDA=',
  callRaw: '+54 9 3816 45-2900',
  ...
  instagram: 'https://www.instagram.com/jbingenieriacorporativa/',
  linkedin: 'https://ar.linkedin.com/company/jb-ingenieria-corporativa',
  facebook: 'https://www.facebook.com/JBCiaPublicitaria',
};

export const HERO = {
  title: 'JB Ingeniería Corporativa S.R.L',
  subtitle: 'La excelencia es nuestro principal objetivo.',
  ctaText: 'Conócenos',
};

export const ABOUT = {
  whoWeAre: 'Hace <strong class="text-blue-300 font-semibold">más de 35 años</strong> acompañamos a empresas y organizaciones en el desarrollo de <strong class="text-[#FFFCFC] font-medium">soluciones de comunicación visual</strong>, combinando tecnología de vanguardia, infraestructura propia y un equipo altamente calificado.\nNuestro compromiso es <strong class="text-blue-300 font-semibold">transformar ideas en proyectos concretos</strong> que fortalezcan la identidad, visibilidad y posicionamiento de cada marca. Por eso, desarrollamos soluciones personalizadas que se adaptan a las necesidades de cada cliente, ya sea en procesos de rebranding, actualización de imagen corporativa o implementación de nuevos espacios y soportes de comunicación.\nTrabajamos en cada etapa del proyecto, garantizando <strong class="text-[#FFFCFC] font-medium">calidad, innovación y resultados que generan impacto</strong>.',
...
export const SERVICES_INTRO_MOBILE = 'Soluciones visuales de alto impacto. Especialistas en imagen corporativa integral para industrias, estaciones y grandes marcas.';
...
export const PILLARS = [
  ...
  { title: 'Herramientas', description: 'Contamos con todas las herramientas y maquinarias específicas para cada tipo de trabajo solicitado.' },
  { title: 'Alto rendimiento', description: 'Contamos con equipos de alta tecnología desde la impresión hasta la terminación para lograr una excelente calidad.' },
  { title: 'Excelencia', description: 'Trabajamos con los materiales más exigentes del mercado para garantizar durabilidad y fidelidad visual.' }
];
